...
namespace back_end.Controllers
{
    ...
    public class CuentasController: ControllerBase
    {
        ...
        [HttpPost("crear")]
        public async Task<ActionResult<RespuestaAutentificacion>> Crear([FromBody] CredencialesUsuario credenciales)
        {
        ...
        [HttpPost("login")]
        public async Task<ActionResult<RespuestaAutentificacion>> Login([FromBody] CredencialesUsuario credenciales)
        {
        ...
        private async Task<RespuestaAutentificacion> ConstruirToken(CredencialesUsuario credenciales)
        {
